...
-- Ticket configuration remains on the 006 schema. Production data contains
-- Discord component IDs and duplicate custom_id values whose intended runtime
-- behavior must be resolved with the Bot rewrite before canonical identities,
-- archival, or stricter configuration constraints can be introduced. The
-- deferred proposal remains in docs/deferred/canonical-ticket-configuration.sql.reference.
