...
VALUES
    (
        'monthly-support',
        'New Season is Live',
        'A new season has started. If you''re getting the Gold Pass, consider using creator code ClashKing.',
        '/settings/support',
        '{ios,android,web}',
        $translations${
          "af": {"title": "Nuwe seisoen is hier", "body": "'n Nuwe seisoen het begin. As jy die Gold Pass koop, oorweeg dit om skepparkode ClashKing te gebruik."},
          "ar": {"title": "الموسم الجديد متاح الآن", "body": "بدأ موسم جديد. إذا كنت ستحصل على Gold Pass، ففكّر في استخدام رمز المنشئ ClashKing."},
          "ca": {"title": "La nova temporada ja és aquí", "body": "Ha començat una nova temporada. Si compraràs el Gold Pass, considera utilitzar el codi de creador ClashKing."},
          "cs": {"title": "Nová sezóna je tady", "body": "Začala nová sezóna. Pokud si pořídíte Gold Pass, zvažte použití kódu tvůrce ClashKing."},
          "da": {"title": "Den nye sæson er i gang", "body": "En ny sæson er begyndt. Hvis du køber Gold Pass, kan du overveje at bruge skaberkoden ClashKing."},
          "de": {"title": "Die neue Saison ist da", "body": "Eine neue Saison hat begonnen. Wenn du den Gold Pass kaufst, verwende gerne den Creator-Code ClashKing."},
          "el": {"title": "Η νέα σεζόν ξεκίνησε", "body": "Μια νέα σεζόν ξεκίνησε. Αν πρόκειται να αγοράσεις το Gold Pass, σκέψου να χρησιμοποιήσεις τον creator code ClashKing."},
          "es": {"title": "La nueva temporada ya está aquí", "body": "Ha comenzado una nueva temporada. Si vas a comprar el Gold Pass, considera usar el código de creador ClashKing."},
          "fi": {"title": "Uusi kausi on täällä", "body": "Uusi kausi on alkanut. Jos aiot hankkia Gold Passin, harkitse sisällöntuottajakoodin ClashKing käyttämistä."},
          "fr": {"title": "La nouvelle saison est arrivée", "body": "Une nouvelle saison a commencé. Si tu achètes le Gold Pass, pense à utiliser le code créateur ClashKing."},
          "he": {"title": "העונה החדשה כאן", "body": "עונה חדשה התחילה. אם בכוונתך לרכוש את ה-Gold Pass, כדאי להשתמש בקוד היוצר ClashKing."},
          "hi": {"title": "नया सीज़न शुरू हो गया है", "body": "एक नया सीज़न शुरू हो गया है। अगर आप Gold Pass खरीद रहे हैं, तो क्रिएटर कोड ClashKing इस्तेमाल करने पर विचार करें।"},
          "hu": {"title": "Itt az új szezon", "body": "Elkezdődött egy új szezon. Ha megveszed a Gold Passt, fontold meg a ClashKing alkotói kód használatát."},
          "it": {"title": "La nuova stagione è arrivata", "body": "È iniziata una nuova stagione. Se acquisti il Gold Pass, considera di usare il codice creatore ClashKing."},
          "ja": {"title": "新シーズン開幕", "body": "新しいシーズンが始まりました。Gold Passを購入する場合は、クリエイターコード「ClashKing」の使用をご検討ください。"},
          "ko": {"title": "새 시즌이 시작되었습니다", "body": "새 시즌이 시작되었습니다. Gold Pass를 구매하신다면 크리에이터 코드 ClashKing을 사용해 주세요."},
          "nl": {"title": "Het nieuwe seizoen is begonnen", "body": "Er is een nieuw seizoen begonnen. Koop je de Gold Pass, overweeg dan de creatorcode ClashKing te gebruiken."},
          "no": {"title": "Den nye sesongen er i gang", "body": "En ny sesong har startet. Hvis du kjøper Gold Pass, kan du vurdere å bruke skaperkoden ClashKing."},
          "pl": {"title": "Nowy sezon już trwa", "body": "Rozpoczął się nowy sezon. Jeśli kupujesz Gold Pass, rozważ użycie kodu twórcy ClashKing."},
          "pt": {"title": "A nova temporada chegou", "body": "Uma nova temporada começou. Se você for comprar o Gold Pass, considere usar o código de criador ClashKing."},
          "ro": {"title": "Noul sezon a început", "body": "A început un sezon nou. Dacă achiziționezi Gold Pass, ia în considerare folosirea codului de creator ClashKing."},
          "ru": {"title": "Новый сезон уже начался", "body": "Начался новый сезон. Если вы покупаете Gold Pass, рассмотрите возможность использовать код автора ClashKing."},
          "sr": {"title": "Нова сезона је почела", "body": "Почела је нова сезона. Ако купујете Gold Pass, размислите о коришћењу кода креатора ClashKing."},
          "sv": {"title": "Den nya säsongen är här", "body": "En ny säsong har börjat. Om du köper Gold Pass kan du överväga att använda skaparkoden ClashKing."},
          "tr": {"title": "Yeni sezon başladı", "body": "Yeni bir sezon başladı. Gold Pass satın alacaksan içerik üreticisi kodu ClashKing'i kullanmayı düşünebilirsin."},
          "uk": {"title": "Новий сезон уже почався", "body": "Розпочався новий сезон. Якщо ви купуєте Gold Pass, скористайтеся кодом автора ClashKing."},
          "ur": {"title": "نیا سیزن شروع ہو گیا ہے", "body": "نیا سیزن شروع ہو گیا ہے۔ اگر آپ Gold Pass خرید رہے ہیں تو کریئیٹر کوڈ ClashKing استعمال کرنے پر غور کریں۔"},
          "vi": {"title": "Mùa giải mới đã bắt đầu", "body": "Một mùa giải mới đã bắt đầu. Nếu bạn mua Gold Pass, hãy cân nhắc sử dụng mã nhà sáng tạo ClashKing."},
          "zh": {"title": "新赛季已开启", "body": "新赛季已经开始。如果你准备购买 Gold Pass，请考虑使用创作者代码 ClashKing。"}
        }$translations$::jsonb,
        'scheduled',
        'monthly',
        1,
